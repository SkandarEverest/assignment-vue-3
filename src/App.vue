...
<template>
  ...
  <div class="container-xxl bg-white p-0">
    ...
    <div class="container-xxl position-relative p-0">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0 mt-0" :class="isSticky? 'sticky-top shadow-sm' : ''">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
              <div class="navbar-nav ms-auto py-0 pe-4 text-start">
                  <a href="index.html" class="nav-item nav-link active">Home</a>
                  <a href="menu.html" class="nav-item nav-link">Menu</a>
                </div>
                <a href="" class="btn btn-primary py-2 px-4 d-md-block mt-2 mt-lg-0">Book A Table</a>
          </div>
      </nav>
              ...
              <div class="col-lg-6">
                  <div class="row g-3">
                      <div class="col-6 text-start">
                          <img class="img-fluid rounded w-100 wow bounceIn" data-wow-delay="0.1s" src="@/assets/img/about-1.jpg">
                      </div>
                      <div class="col-6 text-start">
                          <img class="img-fluid rounded w-75 wow bounceIn" data-wow-delay="0.3s" src="@/assets/img/about-2.jpg" style="margin-top: 25%;">
                      </div>
                      <div class="col-6 text-end">
                          <img class="img-fluid rounded w-75 wow bounceIn" data-wow-delay="0.5s" src="@/assets/img/about-3.jpg">
                      </div>
                      <div class="col-6 text-end">
                          <img class="img-fluid rounded w-100 wow bounceIn" data-wow-delay="0.7s" src="@/assets/img/about-4.jpg">
                      </div>
                  </div>
              </div>
              <div class="col-lg-6">
